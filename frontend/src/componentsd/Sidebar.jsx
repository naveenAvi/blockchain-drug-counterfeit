              ...
              <ul>
                ...
                <li className="submenu">
                  <Link to="#" id="menu-item1" onClick={(e) => {
                    ...
                    <span> Pre Purchase </span> <span className="menu-arrow" />
                  </Link>
                  <ul style={{ display: sidebar === 'Doctors' ? 'block' : 'none' }} className="menu-items1">
                    <li>
                      <Link className={props?.activeClassName === 'doctor-list' ? 'active' : ''} to="/doctorlist">Invoices</Link>
                    </li>
                    <li>
                      <Link className={props?.activeClassName === 'add-doctor' ? 'active' : ''} to="/add-doctor">Create Drug</Link>
                    </li>
                    <li>
                      <Link className={props?.activeClassName === 'edit-doctor' ? 'active' : ''} to="/editdoctor">Drug Lots List</Link>
                    </li>
                  </ul>
                </li>
