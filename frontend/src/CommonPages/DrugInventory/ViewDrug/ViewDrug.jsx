...
const ViewDrug = () => {
  ...
  const rowSelection = {
    ...
    // You can add more options here, e.g. type: 'checkbox' or 'radio'
  };
  ...
  const columns = [
    ...
    },
    {
      title: "Strength",
      dataIndex: "strength",
      sorter: (a, b) => (a.strength || '').localeCompare(b.strength || ''),
    },
    {
      title: "Route",
      dataIndex: "route_of_administration", // Fixed
      sorter: (a, b) => (a.route_of_administration || '').localeCompare(b.route_of_administration || ''),
    },
    {
      title: "Packaging",
      dataIndex: "packaging_type", // Fixed
      sorter: (a, b) => (a.packaging_type || '').localeCompare(b.packaging_type || ''),
    },
    {
      title: "Shelf Life",
      dataIndex: "shelf_life", // Fixed
      sorter: (a, b) => (a.shelf_life || '').localeCompare(b.shelf_life || ''),
    },
    {
      title: "GTIN",
      dataIndex: "gs1_gtin", // Fixed
      sorter: (a, b) => (a.gs1_gtin || '').localeCompare(b.gs1_gtin || ''),
    },
    // {
    //   title: "Status",
    //   dataIndex: "status",
      ...
      render: (text, drug) => (
        <div className="text-end">
          <div className="dropdown dropdown-action">
            <button className="action-icon dropdown-toggle" data-bs-toggle="dropdown">
            ...
            <div className="dropdown-menu dropdown-menu-end">
              ...
              <button
                ...
                className="dropdown-item"
              >
                <FeatherIcon icon="edit-2" size={14} className="me-2" />
                Edit
              </button>
              <button
            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  <li className="breadcrumb-item"><Link to="#">Drugs</Link></li>
                              ...
                              <div className="row">
                                ...
                                <div className="col-md-6">
                                  <div className="form-group mb-3">
                                    ...
                                    <div className="form-control-plaintext border rounded p-2 bg-light">
                                      {selectedDrug?.controlled_substance_schedule || 'Non-controlled'}
                                    </div>
                                  </div>
                                </div>
                                  ...
                                  <div className="col-md-6">
                                    <div className="form-group mb-3">
                                      ...
                                      <input
                                        ...
                                        value={editFormData.name ?? selectedDrug.name ?? ''}
                                  ...
                                  <div className="col-md-6">
                                    <div className="form-group mb-3">
                                      ...
                                      <select
                                        name="type"
                                        className="form-control"
                                        value={editFormData.type ?? selectedDrug.type ?? ''}
                                        onChange={handleEditChange}
                                        required
                                      >
                                  ...
                                  <div className="col-md-6">
                                    <div className="form-group mb-3">
                                      ...
                                      <input
                                        ...
                                        name="drug_id"
                                        className="form-control"
                                        value={editFormData.drug_id ?? selectedDrug.drug_id ?? ''}
                                        onChange={handleEditChange}
                                        required
                                      />
                                    </div>
                                  ...
                                  <div className="col-md-6">
                                    <div className="form-group mb-3">
                                      ...
                                      <input
                                        ...
                                        className="form-control"
                                        value={editFormData.active_ingredients ?? selectedDrug.active_ingredients ?? ''}
                                        onChange={handleEditChange}
                                        required
                                      />
                                    </div>
                                  ...
                                  <div className="col-md-6">
                                    <div className="form-group mb-3">
                                      ...
                                      <input
                                        ...
                                        name="strength"
                                        className="form-control"
                                        value={editFormData.strength ?? selectedDrug.strength ?? ''}
                                        onChange={handleEditChange}
                                        required
                                      />
                                    </div>
                                  ...
                                  <div className="col-md-6">
                                    <div className="form-group mb-3">
                                      ...
                                      <select
                                        ...
                                        className="form-control"
                                        value={editFormData.route_of_administration ?? selectedDrug.route_of_administration ?? ''}
                                        onChange={handleEditChange}
                                      >
                                  ...
                                  <div className="col-md-6">
                                    <div className="form-group mb-3">
                                      ...
                                      <select
                                        name="packaging_type"
                                        className="form-control"
                                        value={editFormData.packaging_type ?? selectedDrug.packaging_type ?? ''}
                                        onChange={handleEditChange}
                                        required
                                      >
                                  ...
                                  <div className="col-md-6">
                                    <div className="form-group mb-3">
                                      ...
                                      <input
                                        ...
                                        name="shelf_life"
                                        className="form-control"
                                        value={editFormData.shelf_life ?? selectedDrug.shelf_life ?? ''}
                                        onChange={handleEditChange}
                                        required
                                      />
                                    </div>
                                  ...
                                  <div className="col-md-6">
                                    <div className="form-group mb-3">
                                      ...
                                      <input
                                        ...
                                        name="gs1_gtin"
                                        className="form-control"
                                        value={editFormData.gs1_gtin ?? selectedDrug.gs1_gtin ?? ''}
                                        onChange={handleEditChange}
                                        required
                                      />
                                    </div>
                                  ...
                                  <div className="col-md-6">
                                    <div className="form-group mb-3">
                                      ...
                                      <input
                                        ...
                                        className="form-control"
                                        value={editFormData.regulatory_approval_region ?? selectedDrug.regulatory_approval_region ?? ''}
                                        onChange={handleEditChange}
                                        required
                                      />
                                    </div>
                                  ...
                                  <div className="col-md-6">
                                    <div className="form-group mb-3">
                                      ...
                                      <input
                                        ...
                                        className="form-control"
                                        value={editFormData.marketing_authorization_holder ?? selectedDrug.marketing_authorization_holder ?? ''}
                                        onChange={handleEditChange}
                                      />
                                    </div>
                                  </div>
                                  <div className="col-md-6">
                                    <div className="form-group mb-3">
                                      ...
                                      <input
                                        ...
                                        name="excipients"
                                        className="form-control"
                                        value={editFormData.excipients ?? selectedDrug.excipients ?? ''}
                                        onChange={handleEditChange}
                                      />
                                    </div>
                                  </div>
                                  <div className="col-md-6">
                                    <div className="form-group mb-3">
                                      ...
                                      <input
                                        ...
                                        className="form-control"
                                        value={editFormData.storage_conditions ?? selectedDrug.storage_conditions ?? ''}
                                        onChange={handleEditChange}
                                      />
                                    </div>
                                  </div>
                                  <div className="col-md-6">
                                    <div className="form-group mb-3">
                                      ...
                                      <input
                                        ...
                                        className="form-control"
                                        value={editFormData.national_drug_code ?? selectedDrug.national_drug_code ?? ''}
                                        onChange={handleEditChange}
                                      />
                                    </div>
                                  </div>
